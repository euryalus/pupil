...
from glfw import *
from circle_detector import CircleTracker, marker_3d_pose
    ...
    def recent_events(self, events):
        ...
        if self.active and frame:
            ...
            if len(self.markers):
                ...
                trans, rot = marker_3d_pose(self.markers[0], self.g_pool.capture.intrinsics, marker_diameter=self.marker_diameter)
                # trans[1,0] *= -1
                print("{:.2f} {:.2f} {:.2f}".format(*trans[:,0]))
                self.pos = trans.tolist()
            else:
